...
var _user$project$Types$Plant = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, latestValue: c, latestReadingAt: d, threshold: e};
	});
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {plants: a, errorMessage: b, currentView: c, focusedPlant: d};
	});
var _user$project$Types$ShowListView = {ctor: 'ShowListView'};
var _user$project$Types$ShowPlantView = function (a) {
	return {ctor: 'ShowPlantView', _0: a};
};
var _user$project$Types$HandlePlantDataResponse = function (a) {
	return {ctor: 'HandlePlantDataResponse', _0: a};
};
var _user$project$Types$PlantDetailView = {ctor: 'PlantDetailView'};
var _user$project$Types$PlantListView = {ctor: 'PlantListView'};
var _user$project$Types$LoaderView = {ctor: 'LoaderView'};
var _user$project$Types$Arum = {ctor: 'Arum'};
var _user$project$Types$Howea = {ctor: 'Howea'};
var _user$project$Types$Monstera = {ctor: 'Monstera'};
...
var _user$project$ViewUtil$getRandomLeaf = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'./icons/leaf_',
		A2(_elm_lang$core$Basics_ops['++'], model.leafNumber, '.svg'));
};
var _user$project$ViewUtil$endYellow = A3(_elm_lang$core$Color$rgb, 255, 201, 102);
var _user$project$ViewUtil$startGreen = A3(_elm_lang$core$Color$rgb, 37, 179, 113);
var _user$project$ViewUtil$getBackgroundColor = function (value) {
	return _eskimoblood$elm_color_extra$Color_Convert$colorToHex(
		A4(_eskimoblood$elm_color_extra$Color_Interpolate$interpolate, _eskimoblood$elm_color_extra$Color_Interpolate$RGB, _user$project$ViewUtil$startGreen, _user$project$ViewUtil$endYellow, value));
};

var _user$project$Styles$textWrapperStyles = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$listItemStyles = F2(
	function (drynessVal, threshold) {
		var t = _elm_lang$core$Basics$toFloat(
			A2(_elm_lang$core$Basics$max, drynessVal, threshold));
		var dry = _elm_lang$core$Basics$toFloat(drynessVal);
		return _elm_lang$html$Html_Attributes$style(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'backgroundColor',
					_1: _user$project$ViewUtil$getBackgroundColor(
						A2(_elm_lang$core$Debug$log, 'd', dry) / A2(_elm_lang$core$Debug$log, 't', t))
				},
				_1: {
					ctor: '::',
...
var _user$project$Styles$listStyles = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$View$detailView = function (model) {
	var _p0 = model.focusedPlant;
	if (_p0.ctor === 'Just') {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$ShowListView),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$View$loaderView = function (model) {
	var _p1 = model.errorMessage;
	if (_p1.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _user$project$View$renderPlant = function (plant) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Types$ShowPlantView(plant)),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Styles$listItemStyles, plant.latestValue, plant.threshold),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src('./icons/leaf_2.svg'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Styles$textWrapperStyles,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(plant.name),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(plant.latestReadingAt),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(plant.latestValue)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Styles$listStyles,
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _user$project$View$renderPlant, model.plants)),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$view = function (model) {
	...
	switch (_p2.ctor) {
		case 'LoaderView':
			return _user$project$View$loaderView(model);
		case 'PlantListView':
			return _user$project$View$listView(model);
		default:
			return _user$project$View$detailView(model);
	}
};
...
var _user$project$Main$initModel = {
	plants: {
		ctor: '::',
		_0: {id: 0, name: 'Blob', latestValue: 0, latestReadingAt: '2017-08-12T22:30:18.800Z', threshold: 0},
		_1: {ctor: '[]'}
	},
	currentView: _user$project$Types$LoaderView,
	errorMessage: _elm_lang$core$Maybe$Nothing,
	focusedPlant: _elm_lang$core$Maybe$Nothing
};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initModel, _1: _user$project$Update$getLatestReading};
